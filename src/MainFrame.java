...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("DesktopImageViewer");

        escritorio.setPreferredSize(new java.awt.Dimension(550, 450));

        author.setText("Autora:Laura del Pino Díaz");

        jMenu1.setText("File");
        jMenu1.setPreferredSize(new java.awt.Dimension(600, 40));
    ...
    private void openMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openMenuItemActionPerformed
        ...
        if(retorno == JFileChooser.APPROVE_OPTION ){
            ...
            if(f != null){
                JInternalFrame internal = new JInternalFrame(f.getName());
